...
namespace Team123it.Arcaea.MarveCube.LinkPlay.Core
{
    public static class LinkPlayCrypto
    {
        ...
        public static Task<byte[]> DecryptPack(byte[] data)
        {
            return Task.Run(() =>
            {
                ...
                if (decrypted.Length % 16 == 0) return decrypted;
